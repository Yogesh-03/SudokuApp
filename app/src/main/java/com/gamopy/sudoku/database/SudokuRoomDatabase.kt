...
@Database(
    entities = [SudokuEntity::class, SudokuEasyData::class, SudokuMediumData::class, SudokuHardData::class, SudokuExpertData::class],
    version = 1,
    exportSchema = false
)
abstract class  SudokuRoomDatabase : RoomDatabase() {
    ...
    abstract fun getEasySudokuDao():EasySudokuDao
    abstract fun getMediumSudokuDao():MediumSudokuDao
    abstract fun getHardSudokuDao():HardSudokuDao
    abstract fun getExpertSudokuDao():ExpertSudokuDao
