...
class MyRecyclerViewAdapter(
    private val sudokuEntityList: List<SudokuEntity>,
    private val dataViewModel: SudokuDataViewModel
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.sudoku_data_item, parent, false)
...
class MyViewHolder(itemView: View, private val dataViewModel: SudokuDataViewModel) : ViewHolder(itemView) {
    ...
    private val isCompleted = itemView.findViewById<ImageView>(R.id.ivIsCompleted)
...
//   private val hintsUsed = itemView.findViewById<TextView>(R.id.tvHintsUsed)
    ...
    fun bind(sudokuEntity: SudokuEntity) {
        ...
        if (sudokuEntity.isCompleted == true){
            isCompleted.setImageResource(R.drawable.completed)
        } else if (sudokuEntity.isCompleted == false){
            isCompleted.setImageResource(R.drawable.incompleted)
        }
        //   mistakes.text = sudokuEntity.mistakes.toString()
//        isCompleted.text = sudokuEntity.isCompleted.toString()
//        hintsUsed.text = sudokuEntiqty.hintsUsed.toString()
